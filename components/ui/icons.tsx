...
export function MenuIcon({ size = 24, color = '#000000' }: IconProps) {
  return (
    <Svg width={size} height={size * 14/19} viewBox="0 0 19 14" fill="none">
      <Path
        d="M1 12.6667H17.3333M1 6.83333H17.3333M1 1H10.3333"
        stroke={color}
        strokeWidth={2}
        strokeLinecap="round"
...
export function PenIcon({ size = 24, color = '#ACACAC' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function TokenIcon({ size = 24, color = '#000000' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function ChevronRightIcon({ size = 24, color = '#999999' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M9 18L15 12L9 6"
...
export function MessageCircleIcon({ size = 24, color = '#000000' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
