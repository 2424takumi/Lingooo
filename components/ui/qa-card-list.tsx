...
export function QACardList({ pairs, onRetry, scope, identifier, onLastCardLayout, onBookmarkAdded, onCopied, onFollowUpQuestion, onEnterFollowUpMode, activeFollowUpPairId, onScrollToFollowUpInput }: QACardListProps) {
  if (!pairs.length) {
    return null;
  }
